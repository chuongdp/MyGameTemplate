     ...
     namespace DVAH
     {
          public class AdUnitModuleReward_Admob : AdUnitModule
          {
               Dictionary<string, RewardedAd> _unitObjs         = new Dictionary<string, RewardedAd>();
          ...
          #region Reward Handle
               ...
               void OnAdDisplayedEvent(RewardedAd ad, string adUnitId)
               {
               ...
               void OnAdClickedEvent(RewardedAd ad, string adUnitId)
               {
               ...
               void OnAdDisplayFailedEvent(RewardedAd ad, AdError errorInfo, string adUnitId)
               {
                    //string adUnitId = ad.GetResponseInfo().GetLoadedAdapterResponseInfo().AdSourceId;
                    string adNetwork = ad.GetResponseInfo().GetMediationAdapterClassName();
               ...
               public void OnAdDismissedEvent(RewardedAd ad, string adUnitId)
               {
                    //string adUnitId = ad.GetResponseInfo().GetLoadedAdapterResponseInfo().AdSourceId;
               ...
               void OnAdPaid(RewardedAd adInfo, AdValue adValue, string adUnitId)
               {
          ...
          #region SHOW/LOAD ad
               ...
               public override void Show(int ID = 0, Action<int, AdUnitState> callback = null, string placement = null)
               {
                    ...
                    _unitObjs[_unitIDs[ID]].
                         Show(reward =>
                         {
                              try
                              {
                                   callback?.Invoke(ID, AdUnitState.Watched);
               ...
               public override void Load(int ID = 0)
               {
                    ...
                    RewardedAd.Load(_unitIDs[ID], adRequest, (RewardedAd ad, LoadAdError error) =>
                    {
