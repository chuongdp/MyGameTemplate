...
namespace DVAH
{
    public class MiraiCoroutineEditor
    {
        /// <summary>
        ...
        private MiraiCoroutineEditor(IEnumerator enumerator)
        {
        ...
        public static MiraiCoroutineEditor StartCoroutine(IEnumerator enumerator)
        {
            var coroutine = new MiraiCoroutineEditor(enumerator);
            coroutine.Start();
            return coroutine;
        }
